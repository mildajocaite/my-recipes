...
export const spinatuTortas: Recipe = {
  ...
  steps: [
    ...
    "Kol želė stingsta, išsiketi biskvitą. Cukrų, vanilinį cukrų ir kiaušinius išplakti iki purumo. Aliejų su špinatų lapais sublenderuoti. Į kiaušinių masę supilti špinatus, suberti miltus ir kepimo miltelius. Viską gerai išmaišyti, supilti į norimą skardą (geriausia į tokią, kokį tortą formuosite). Kepti apie 35-40 min. 180 laipsnių temperatūroje.",
    "Grietinėlę, maskorponės sūrį ir cukraus pudrą išplakti iki purios masės. Supilti atvėsusią, ištripintą želatiną.",
    "Atvėsusiam biskvitui nupjauti viršūnę ir sutrupinti į trupinius (bus papuošimui). Ant biskvito dėti sustingusią želė",
    "Ant viršaus dėti kremo masę, biskvito trupinius ir laikyti per naktį.",
    "Puošti su šviežiomis uogomis.",
  ],
  image: image,
  mostPopular: true,
};
